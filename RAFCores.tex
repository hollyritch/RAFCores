...
\begin{figure}[htb]
  ...
  \begin{minipage}[c]{\textwidth}
    ...
    \begin{minipage}[c]{0.5\textwidth}
      \centering
      \includegraphics[width=0.9\textwidth]{./Pictures/IrrRAFCoresn5rev2.png}
    \end{minipage}%
    \hfill%
    \begin{minipage}[c]{0.5\textwidth}
      \centering
      \includegraphics[width=0.9\textwidth]{./Pictures/IrrRAFCoresn5rev.png}
    \end{minipage}
  \end{minipage}
%  \begin{minipage}[c]{\textwidth}
%    \centering
...
Def.~\ref{def:irrerRAF} directly yields the following two structural lemma.
\vspace{6pt}
...
\end{proof}
We remark that \eqref{eq:inverse} in particular formally excludes the
presence, in any irreducible RAF, of two reactions that are one the reverse
of the other.

\Wim{To add as a follow-up result: an irreducible RAF is also unique in the sense of its set of ``reversible'' reactions. More specifically, it cannot be the case that there is another irreducible RAF with the same set of reactions (in the reversible sense), but with any subset of the reactions going in the reverse direction. The only exception is a trivial irreducible RAF where all molecules involved are in the food set. To be stated more formally...}
...
are nonnegative \cite{blokhuis_Universal_2020,
  vassena_unstable_2024,golnik_autocatalytic_2026}. Matrices with
...
\begin{figure}
	...
	\begin{minipage}[c]{0.5\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./Pictures/IrrRAFCoresn5revWithVsWithoutFood.png}
	\end{minipage}%
	\hfill%
	\begin{minipage}[c]{0.5\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./Pictures/IrrRAFCoresn5rev2WithVsWithoutFood.png}
	\end{minipage}%
	\caption{Autocatalytic cores in irreducible RAFs from two random instances of the binary polymer model with and without food molecules.} 
\end{figure}
