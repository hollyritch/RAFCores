...
\begin{figure}[htb]
  ...
  \begin{minipage}[c]{\textwidth}
    ...
    \begin{minipage}[c]{0.5\textwidth}
      \centering
      \includegraphics[width=0.9\textwidth]{./Pictures/n7iRAFirrevCoresWFood.png}
    \end{minipage}
  \end{minipage}
%  \begin{minipage}[c]{\textwidth}
%    \centering
...
\begin{figure}
	...
	\begin{minipage}[c]{\textwidth}	
		...
		\begin{minipage}[c]{0.5\textwidth}
			\centering
			\includegraphics[width=\textwidth]{./Pictures/n7iRAFirrevWithVsWOFood.png}
		\end{minipage}
	\end{minipage}
	\begin{minipage}[c]{\textwidth}	
		\begin{minipage}[c]{0.5\textwidth}
			\centering
			\includegraphics[width=\textwidth]{./Pictures/n6iRAFrevWFoodRelevantStrongBlocks.png}
		\end{minipage}%
		\hfill%
		\begin{minipage}[c]{0.5\textwidth}
			\centering
