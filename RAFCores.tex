...
\begin{figure}[htb]
  ...
  \begin{minipage}[c]{\textwidth}
    ...
    \begin{minipage}[c]{0.5\textwidth}
      \centering
      \includegraphics[width=0.9\textwidth]{./Pictures/IrrRAFCoresn5rev1.png}
    \end{minipage}%
    \hfill%
    \begin{minipage}[c]{0.5\textwidth}
      \centering
...
%  \end{minipage}
  \begin{minipage}[c]{\textwidth}
    ...
    \begin{minipage}[c]{0.5\textwidth}
      \centering
      \includegraphics[width=\textwidth]{./Pictures/n5_1_split_present.pdf}
    \end{minipage}%
    \hfill%
    \begin{minipage}[c]{0.5\textwidth}
      \centering
      \includegraphics[width=1.05\textwidth, height = 4.75cm]{./Pictures/n5_2_split_present.pdf}
    \end{minipage}
  \end{minipage}	
  \caption{Irreducible RAFs typically contain many autocatalytic
      ...
      (\textbf{left}) and maximum polymer length $5$.  See
      Sect.~\ref{sect:term} for the definition of terminology and
      SI Sect.~\ref{S-sec:BinPol} for simulation details.}
...
\begin{figure}
	...
	\begin{minipage}[c]{0.5\textwidth}
		\centering
		\includegraphics[width=\textwidth]{./Pictures/IrrRAFCoresn5rev1WithVsWithoutFood.png}
	\end{minipage}%
	\hfill%
	\begin{minipage}[c]{0.5\textwidth}
		\centering
