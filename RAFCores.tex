...
%  \end{minipage}
  ...
  \caption{Irreducible RAFs typically contain many autocatalytic
      ...
      (\textbf{left}) and maximum polymer length $6$. While the \textbf{right} 
      includes only ligation reactions, the \textbf{left} includes both ligation and
      cleavage reaction. See Sect.~\ref{sect:term} for the definition of terminology 
...
%	\begin{minipage}[c]{0.5\textwidth}
%		\centering
%		\includegraphics[width=\textwidth]{./Pictures/n6iRAFirrevWFoodRelevantStrongBlocks.png}
%	\end{minipage}
