...
\begin{figure}[bth]
	...
	\begin{minipage}[c]{\textwidth}
		\begin{minipage}[c]{0.5\textwidth}
			\centering
		\includegraphics[width=0.8\textwidth]{./Pictures/iRAFrevStrongBlocksWOFood.png}
		\end{minipage}%
		\hfill%
		\begin{minipage}[c]{0.5\textwidth}
			\centering
			\includegraphics[width=0.8\textwidth]{./Pictures/iRAFirrevStrongBlocksWOFood.png}
		\end{minipage}
	\end{minipage}
		\caption{Number of maximal strong blocks containing at least one non-food, 
			...
			with \textbf{(upper)} and without \textbf{(lower)} food species. See SI 
			Table~\ref{tab:SimulationDetails}. Dots, each representing an irreducible 
